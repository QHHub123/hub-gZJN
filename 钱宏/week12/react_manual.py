...
def run(question: str, max_steps: int = 10, history_messages: List[Dict] = None, verbose: bool = True) -> Generator[dict, None, None]:
    """
    ...
    message_handler = MessageHandler(SYSTEM_PROMPT)
    ...
    for step in range(1, max_steps + 1):
        ...
        # 将本步结果追加到对话历史
        message_handler.add_manual_message(llm_output, observation)
